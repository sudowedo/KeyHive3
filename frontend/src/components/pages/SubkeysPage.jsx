...
export default function SubkeysPage({ ctx }) {
  ...
  const updateStatus = async (nextStatus) => {
    ...
    if (nextStatus === 'revoked' && !window.confirm(`Revoke "${editingSubkey.name}"? This cannot be undone for existing issued token behavior.`)) return;
    const prev = [...subkeys];
